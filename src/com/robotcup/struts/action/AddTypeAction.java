...
import com.robotcup.struts.form.ItemsTypeForm;
 ...
 * 
 * XDoclet definition:
 * @struts.action path="/addType" name="itemsTypeForm" scope="request" validate="true"
 */
@Controller
public class AddTypeAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		ItemsTypeForm itemsTypeForm = (ItemsTypeForm) form;// TODO Auto-generated method stub
		if(!teamAdminServiceImp.isTypeRepeat(itemsTypeForm.getTyname()))
		{
			ItemsType itemsType=new ItemsType();		
			itemsType.setTyname(itemsTypeForm.getTyname());
			teamAdminServiceImp.addType(itemsType);
